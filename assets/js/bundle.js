...
var App = function () {
  ...
  _createClass(App, [{
    ...
    value: function handleMovieDetail(id) {
      _axios2.default.all([this.Movie.find(id), this.Movie.certification(id)]).then(_axios2.default.spread(function (details, certification) {
        var data = {
          details: details.data,
          certification: certification.data
        };
        _ui2.default.show(data);
      })).catch(function (err) {
        throw new Error(_helpers2.default.makeError(err));
      });
    }
...
},{"./helpers":2,"./movie":3,"./ui":4,"axios":5}],2:[function(require,module,exports){
'use strict';
...
},{"./helpers":2,"axios":5}],4:[function(require,module,exports){
'use strict';
...
var UI = function () {
  ...
  _createClass(UI, [{
    ...
    value: function renderDetail(data) {
      var _data$details = data.details,
          title = _data$details.title,
          overview = _data$details.overview,
          genres = _data$details.genres,
          backdrop = _data$details.backdrop_path,
          voteAverage = _data$details.vote_average,
          releaseDate = _data$details.release_date;
      var certification = data.certification.release_dates.filter(function (obj) {
        return obj.certification !== '';
      })[0].certification;
    ...
    value: function show(data) {
      ...
      var certification = data.certification.results.filter(function (obj) {
        return obj.iso_3166_1 === 'US';
      })[0];
      var details = data.details;

      var movie = { details: details, certification: certification };
